...
###########################################################################
#
# QueueMessageFrameBase Class
#
###########################################################################
class QueueMessageFrameBase():
    '''
    ...
    def __init__(self):
        ...
        Returns:
            Task: An instance of the QueueMessageFrameBase class
...
###########################################################################
#
# Queue Message Frames derived from the QueueMessageFrameBase class
#
class BasicQueueMessageFrame(QueueMessageFrameBase):
    ''' Basic Message Frame '''
...
class InvalidQueueMessageFrame(QueueMessageFrameBase):
    ''' Invalid Message Frame - Used for error handling'''
    pass
...
class QueueMessage():
    ...
    def __init__(
                ...
                frame: type[QueueMessageFrameBase] = BasicQueueMessageFrame
    ):
        '''
        Initializes the instance.
        ...
        if isinstance(_class, QueueMessageFrameBase) or \
                issubclass(_class, QueueMessageFrameBase):

            self.__frame: type = _class
        else:
            self.__frame: type = InvalidQueueMessageFrame
