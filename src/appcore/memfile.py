...
class MemFile():
    ...
    def decrypt(
        ...
        If a key is provided, that will be use to decrypt the file.  It must be
        a fernet encryption key.

        If a password is provided, a decryption key will be derived using the
        password and the salt will be assumed to be the header of the encrypted
        file.
        ...
        If neither the key or password is provided, the key will be derived
        using an empty password and the salt will be assumed to be the header
